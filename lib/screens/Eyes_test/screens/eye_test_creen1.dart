      ...
      child: Scaffold(
        ...
        backgroundColor: Colors.white,
          automaticallyImplyLeading: false,
           ...
           Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>VertigoTest(id: medical_id,)));
              ...
              child: Row(
                ...
                Column(
                  children: [
                    InkWell(
                      onTap: () {
                         Navigator.push(context, MaterialPageRoute(builder:(context) => EyeTestScreen2(medical_id: medical_id,),));
;                      },
                      child: CircleAvatar(
                    ...
                    Text("Color Blindness",style: GoogleFonts.poppins(),)
                  ],
                ),
                 Column(
                  children: [
                    InkWell(
                      onTap: () {
                         Navigator.push(context, MaterialPageRoute(builder:(context) => VisualEyeTest()));
;                      },
                      child: CircleAvatar(
                        backgroundColor: Colors.grey.shade400,
                        radius: 45,
                    ...
                    Text("Visual Testing",style: GoogleFonts.poppins(),)
                  ],
                ),
                //  InkWell(
                //   onTap: () {
            ...
            Text("Welcome to Eye's Text",style: GoogleFonts.poppins(fontSize: 30,fontWeight: FontWeight.bold,color: Coloors.fontcolor),)
           ],
        ),
      ),
    );
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text("EYE TEST",style: GoogleFonts.poppins(color: Colors.white,fontSize: 30,fontWeight: FontWeight.bold),),
                ),
                  Container(
            height: 100,
            width: 200,
