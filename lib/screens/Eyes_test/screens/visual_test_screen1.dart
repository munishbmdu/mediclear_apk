             ...
             Center(
               child: CircleAvatar(
                    ...
                    height: 10,
                                 ...
                                 Text("Better vision also means more quality of life, as sight is our most important sensory organ",style: GoogleFonts.poppins(fontSize: 18,color: Coloors.fontcolor),textAlign: TextAlign.center,),
                    Container(
                      width: 350,
                      child: TextButton(onPressed:() {
                        Navigator.pushReplacement(context, MaterialPageRoute(builder:(context) =>VisualTestScreen2()));
                      }, 
