...
class _FlatFootTestScreen3State extends State<FlatFootTestScreen3> {
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Center(
                  child: Text("Here! , Click or Upload Image",
  ...
  Future imagePicker() async {
    ...
    CroppedFile? croppedFile =
        await ImageCropper().cropImage(sourcePath: returnedImage!.path);
  ...
  Future<void> uploadImage(
    ...
    try {
      ...
      var request = http.MultipartRequest(
          'POST', Uri.parse("${ApiDomain().url}flatfoot"));
      request.headers['Authorization'] = 'Bearer ' + '$token';

      var image =
          await http.MultipartFile.fromPath('flatfoot', imageFile!.path);
                ...
                content: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        "Hurrah!!, FlatFoot done successfully",
                      )
                    ],
                  ),
                ),
